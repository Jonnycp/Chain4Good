...
%Per supportare le diverse fasi di sviluppo del \textit{software} sono stati utilizzati i seguenti strumenti:

%\begin{itemize}
%	\item \textit{Visual studio code}
%	\item \textbf{Git}: software di controllo di versione distribuito, utilizzato per il tracciamento delle modifiche del codice sorgente.
%	\item \textbf{GitHub}: piattaforma di \textit{hosting} del \textit{repository} remoto e supporto alla collaborazione.
%	\item \textbf{Docker}: tecnologia di containerizzazione per la standardizzazione dell’ambiente di esecuzione.
%\end{itemize}
