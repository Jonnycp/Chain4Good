...
A differenza dei modelli tradizionali in cui le risorse raccolte vengono trasferite integralmente all'Ente al termine della raccolta, infatti, in Chain4Good l’erogazione delle risorse è incrementale ed è subordinata ad un processo di approvazione decentralizzato, attraverso il quale i donatori possono esprimere il proprio consenso in merito alle richieste di spesa.

Tale meccanismo non è esente da potenziali comportamenti fraudolenti, poiché la tecnologia \textit{blockchain} non è in grado di garantire la veridicità dei dati forniti \textit{off-chain}, quali i preventivi allegati alle richieste di spesa. 
Tuttavia, essa consente di rendere l’intero processo di richiesta, approvazione ed erogazione delle risorse immutabile, trasparente e pubblicamente verificabile, grazie alla registrazione \textit{on-chain} di ogni operazione e di ogni trasferimento di fondi. 
In questo modo, l'idea stessa di donazione evolve, trasformandosi da un mero atto di fiducia ad un processo intrinsecamente sicuro e verificabile in ogni sua fase.

%le risorse raccolte vengono trasferite al \textit{wallet} dell'Ente promotore dell'iniziativa. \\
