...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{p{4cm} p{9cm}}
			...
			\hline
			Hardhat & Ambiente di sviluppo utilizzato per la compilazione, il testing e il \textit{deployment} degli \textit{Smart Contract}, nonché per la simulazione di una \textit{blockchain} locale. \\
			\hline
