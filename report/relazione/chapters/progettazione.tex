...
In particolare, nella Tabella~\ref{tab:requisiti_funzionali} sono riportati i requisiti funzionali, ossia funzionalità che la piattaforma deve implementare. \\
Nella Tabella \ref{tab:requisiti_non_funzionali}, invece, sono descritti i requisiti non funzionali i quali rappresentano tutte le caratteristiche che, pur non essendo funzionalità dirette, il sistema deve garantire. 
