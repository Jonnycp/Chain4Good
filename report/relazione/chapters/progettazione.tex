...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{p{4cm} p{9cm}}
			...
			\hline
			Visual Studio Code & Utilizzato come \gls{ide} principale; la sua natura altamente estensibile ha permesso l’integrazione di estensioni funzionali allo sviluppo del progetto. \\
			\hline
