...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{p{4cm} p{9cm}}
			...
			\hline
			Hardhat & Ambiente di sviluppo impiegato per simulare una \textit{blockchain} locale durante la fase di sviluppo. \\
			\hline
	...
	\caption{Tecnologie utilizzati per la componente \textit{blockchain}.}
