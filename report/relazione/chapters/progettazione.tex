...
I requisiti funzionali elencati definiscono le funzionalità attese del sistema.

Requisiti funzionali per gli Enti Beneficiari:
\begin{enumerate}
	\item \textbf{Creazione progetto}:
...
Requisiti funzionali per gli utenti donatori:
\begin{enumerate}
	\item \textbf{Consultazione dei progetti}:
	\item \textbf{Donazione ad un progetto}: 
	\item \textbf{Votazione delle richieste di spesa}:
	\item \textbf{Consultazione dello storico delle donazioni}:
\end{enumerate}


Requisiti funzionali per la piattaforma:
\begin{enumerate}
