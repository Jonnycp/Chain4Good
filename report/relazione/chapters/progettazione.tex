...
La presente sezione fornisce una panoramica delle tecnologie impiegate per lo sviluppo della piattaforma, organizzate in base alle principali componenti architetturali del sistema. \\
In particolare, la Tabella~\ref{tab:frontend_stack} riporta le tecnologie utilizzate per l’implementazione della componente \textit{front-end}, mentre la Tabella~\ref{tab:backend_stack} elenca quelle adottate per lo sviluppo della componente \textit{back-end}. 
Le tecnologie relative alla componente \textit{blockchain} sono invece sintetizzate in Tabella~\ref{tab:blockchain_stack}.\\
Visual Studio Code è stato inoltre utilizzato come \gls{ide} principale. \\
Al fine di supportare l'organizzazione del lavoro e garantire la portabilità del sistema \textit{software}, invece sono stati inoltre impiegati gli strumenti riportati in Tabella~\ref{tab:development_tools}.i 
