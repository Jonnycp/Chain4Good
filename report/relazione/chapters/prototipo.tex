...
Una volta sottomessa, la richiesta viene sottoposta a un meccanismo di valutazione decentralizzato, basato sul voto dei donatori che hanno contribuito al finanziamento del progetto. Durante un intervallo temporale prefissato, tali utenti possono esprimere un parere favorevole o contrario allo sblocco dei fondi, contribuendo così al processo decisionale relativo all’utilizzo delle risorse raccolte.E'\ importante sottolineare che il meccanismo di voto adottato assegna lo stesso peso a ciascun votante, indipendentemente dall’importo donato, al fine di garantire un processo decisionale equo e non dipendente dalla capacità economica dei singoli partecipanti, in coerenza con la natura della piattaforma. \\
La sottomissione di una nuova richiesta di spesa è inoltre vincolata al caricamento della prova di acquisto relativa all'ultima richiesta approvata dalla comunità di votanti (insieme degli individui che finanzia un'iniziativa di \gls{cf}).
