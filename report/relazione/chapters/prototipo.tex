...
Infine, il \textit{front-end} utilizza il \textit{cookie} di sessione per recuperare le informazioni dell’utente autenticato e completare il processo di accesso all’applicazione.
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=1\textwidth]{images/login_DEFINITIVO.png}
...
\begin{figure}
	\centering
	\includegraphics[width=1\textwidth]{images/DASHBOARD_DEFINITIVO.png}
...
\begin{figure}
	...
	\caption{Inserimento e valutazione di una nuova richiesta di spesa.}
...
\begin{figure}
	\centering
	{
		\includegraphics[
		width=0.9\textwidth
		]{images/SPESA_SEQUENZA.png}
	}
	\caption{Digramma di sequenza relativo alla creazione e valutazione di una richiesta di spesa.}
