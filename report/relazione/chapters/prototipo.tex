...
L'accesso alla piattaforma Chain4Good adotta il paradigma dell'identità decentralizzata. La procedura di \textit{login} avviene esclusivamente attraverso l'interfacciamento con \textit{Metamask}, che funge da interfaccia tra l'utente e la rete \textit{blockchain}.
