...
\begin{itemize}
	\item \textbf{Approvazione per maggioranza alla scadenza}: la richiesta è approvata se, al termine del periodo di votazione, i voti favorevoli rappresentano almeno il 50\% del totale dei voti espressi;
	
	\item \textbf{Approvazione anticipata per maggioranza matematica}: il sistema prevede la chiusura anticipata della votazione qualora il numero di pareri favorevoli raggiunga una soglia tale da rendere l'esito finale non più invertibile, anche nell'ipotesi in cui tutti i restanti aventi diritto esprimessero voto contrario;
	...
	\item \textbf{Mancata partecipazione}: nel caso in cui non venga espresso alcun voto entro l’intera finestra temporale di valutazione (pari a tre giorni), il sistema applica il principio del silenzio-assenso, approvando automaticamente la richiesta al fine di non ostacolare l’avanzamento del progetto.
