...
\begin{itemize}
	\item durante il primo step, l'Ente deve specificare il nome del progetto, la categoria (come istruzione, ambiente), l’obiettivo economico e il termine temporale della raccolta. Alcune di queste variabili sono essenziali per automatizzare la gestione dei fondi in modalità \textit{trustless}, in quanto lo \textit{Smart Contract} li utilizza per determinare il successo della campagna;
	
	\item il secondo step, invece, richiede l'inserimento di un piano dettagliato delle spese, oltre ad una descrizione del progetto e un'immagine di copertina. Tale prospetto non ha solo finalità informative, in quanto mira ad incrementare la credibilità dell'iniziativa e a consolidare il rapporto fiduciario con i donatori. 
