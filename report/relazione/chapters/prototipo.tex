...
\begin{figure}[!h]
	\centering
	\includegraphics[width=1\textwidth]{images/sequenza_login.jpeg}
...
\begin{itemize}
	\item \textbf{Approvazione per maggioranza alla scadenza}: la richiesta è approvata se, al termine del periodo di votazione, i voti favorevoli sono maggiori; % voti favorevoli maggiori dei negati - togli maggiore uguale 
