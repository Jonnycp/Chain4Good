...
Tale scelta progettuale risulta coerente con la categoria di Enti autorizzati alla creazione delle iniziative, individuati esclusivamente in Enti del Terzo Settore e \gls{onp}, per i quali anche contributi parziali possono risultare funzionali al perseguimento delle finalità sociali.
...
\begin{itemize}
	\item durante il primo step, l'Ente deve specificare il nome del progetto, la categoria (come istruzione, ambiente), l’obiettivo economico e il termine temporale della raccolta. \\
	...
	\item il secondo step, invece, richiede l'inserimento di un piano dettagliato delle spese, oltre ad una descrizione del progetto e un'immagine di copertina. \\
	Tale prospetto non ha solo finalità informative, poiché mira ad incrementare la credibilità dell'iniziativa e a consolidare il rapporto fiduciario con i donatori. Questi ultimi, infatti, possono utilizzare queste informazioni come parametro di confronto al fine di la coerenza degli obiettivi dichiarati con le motivazioni relative alle richieste di spesa.
