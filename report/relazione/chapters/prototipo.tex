...
La sottomissione di una nuova richiesta di spesa, tuttavia, è vincolata al caricamento della prova di acquisto relativa all'ultima richiesta approvata dalla comunità di votanti (insieme degli individui che finanzia un'iniziativa di \gls{cf}).
...
Il sistema adotta un meccanismo di voto non ponderato, in cui ciascun partecipante dispone di un singolo voto, indipendentemente dall'importo donato, in coerenza con la natura benefica della piattaforma.
...
\begin{itemize}
	...
	\item In presenza di una partecipazione parziale, la soglia di maggioranza viene ricalcolata in funzione dei soli voti espressi;
	\item Qualora non venga registrata alcuna attività di voto il sistema approva automaticamente la richiesta a seguito della scadenza dei 3 giorni;
\end{itemize}
