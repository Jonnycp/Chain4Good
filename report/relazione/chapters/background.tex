...
Nata come infrastruttura di supporto per la criptovaluta Bitcoin \cite{nakamoto2007bitcoin}, la blockchain si è progressivamente evoluta in una tecnologia \textit{general-purpose}, trovando applicazione in un'ampia gamma di contesti. \cite{panarello2018blockchain}.
