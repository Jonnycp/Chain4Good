...
Alla base di questa tecnologia vi è il concetto di \gls{dlt}, un registro distribuito, condiviso e sincronizzato tra più nodi di una rete \textit{peer-to-peer}. 
