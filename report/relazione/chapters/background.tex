...
Una blockchain è una base di dati distribuita, condivisa e immutabile. Nata inizialmente come infrastruttura di supporto per la criptovaluta Bitcoin \cite{nakamoto2007bitcoin}, la blockchain si è evoluta in una tecnologia \textit{general-purpose}, trovando  applicazione in un'ampia gamma di contesti. \\
Alla base di questa tecnologia vi è il concetto di \gls{dlt}, un registro distribuito, condiviso e sincronizzato tra più nodi di una rete \textit{peer-to-peer}(P2P).
