...
La pianificazione delle attività ha previsto l'identificazione sistematica di tutte le fasi operative di progetto, tramite la redazione di un elenco delle principali attività da svolgere (Tabella~\ref{table:pianificazione}). \\ Successivamente, per gestire la sequenzialità e il parallelismo dei \textit{task} individuati, è stato redatto Diagramma di Gantt. \\
...
\begin{table}[h]
	...
	\begin{tabularx}{\textwidth}{|
		...
		T7 & \textit{Design} delle interfacce utente & 25 \\
		\hline
		...
		T14 & Consegna & 2 \\
		\hline
		\multicolumn{2}{|r|}{\textbf{Totale ore}} & \textbf{226} \\
		\hline
	\end{tabularx}
...
La stima dei costi del progetto è stata effettuata in termini di tempo/persona, tenendo conto della natura prototipale del progetto, della dimensione del sistema, delle tecnologie adottate e dell’esperienza di dominio di ciascuno.
Per dare una base quantitativa alla stima, si è fatto riferimento al modello algoritmico \gls{cocomo}, applicando la formula:

$$
	\frac{M}{P} = C \times D \times \times S \times M
$$
