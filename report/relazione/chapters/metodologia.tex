...
Successivamente, per gestire la sequenzialità e il possibile parallelismo tra i \textit{task} individuati, è stato elaborato un Diagramma di Gantt, utilizzato come strumento di supporto alla pianificazione temporale. \\
...
La stima dei costi del progetto è stata effettuata sulla base della durata delle attività definite in fase di pianificazione, come riportato in \ref{table:pianificazione}. \\
La stima della durata è stata ottenuta mediante una scomposizione delle attività progettuali in \textit{task} elementari, a ciascuno dei quali è stata associata una stima temporale basata sulla complessità dell’attività. Lo sforzo complessivo stimato risulta pari a \textbf{228 ore}. \\
...
Trattandosi di un progetto a scopo didattico, la stima dei costi non è stata tradotta in un valore economico monetario, ma utilizzata come strumento di supporto alla pianificazione e alla verifica della fattibilità del progetto entro i vincoli temporali prestabiliti.
