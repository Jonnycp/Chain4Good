...
Per mitigare tale rischio si è deciso di implementare un meccanismo di custodia decentralizzata dei fondi, affinché le risorse raccolte fossero sbloccate esclusivamente a seguito dell'approvazione delle richieste di spesa da parte dei donatori. Per rafforzare ulteriormente la trasparenza del processo, inoltre, si è deciso di vincolare la presentazione di una nuova richiesta al caricamento del preventivo della precedente. 

Un’ulteriore fonte di rischio è rappresentata dalla volatilità delle criptovalute utilizzate per effettuare le donazioni. Per mitigare tale rischio, il sistema è stato progettato per utilizzare \textit{stablecoin}, ossia criprovalute progettate per mantenere un valore stabile rispetto a un \textit{asset} di riferimento (garantendo un rapporto 1:1 con valute fiat come il dollaro statunitense o l'euro).
