...
La letteratura converge nel considerare la \textit{blockchain} come una soluzione promettente per il superamento delle criticità strutturali delle piattaforme di \gls{cf} esistenti precedentemente discusse \cite{shelke2022blockchain}. \\
Nello specifico, l'efficacia di tale tecnologia risiede nella capacità di implementare nativamente le proprietà di decentralizzazione, trasparenza e sicurezza (Tabella~\ref{tab:blockchain_vantaggi}).




%\\La \textit{blockchain} è un registro distribuito, condiviso e immutabile, strutturato in una catena sequenziale di blocchi. Ciascun blocco contiene un insieme di transazioni (ossia operazioni richieste dagli utenti, come il trasferimento di \textit{asset} digitali) la cui validità e integrità sono garantite da protocolli di consenso, eseguiti in modo distribuito all’interno di una rete \gls{p2p} \cite{nakamoto2007bitcoin}.
...
% Le regole di gestione dei fondi (come le soglie di rilascio o le condizioni di rimborso) divengono vincoli ingegneristici non manomissibili, rendendo la piattaforma una strategia di finanziamento \textit{state-of-the-art} \cite{hartmann2019alternative}. L'adozione della \textit{blockchain} permette quindi di disintermediare il processo, eliminando i \textit{gatekeeper} centralizzati e riducendo drasticamente le asimmetrie informative tra donatori e beneficiari \cite{alia2024ihsan}.


% Le proprietà di trasparenza, affidabilità e fiducia, identificati come fattori determinanti per il successo di una piattaforma di \gls{cf}, non rappresentano più meri obiettivi da perseguire, bensì proprietà strutturali garantite dalla \textit{blockchain} stessa (Tabella~\ref{tab:blockchain_vantaggi}).



% La letteratura converge nel considerare la \textit{blockchain} come una soluzione promettente per il superamento delle criticità strutturali delle piattaforme di \gls{cf} esistenti \cite{shelke2022blockchain}. 

%Adottando questa tecnologia, le proprietà di trasparenza, affidabilità e fiducia, identificati come fattori determinanti per il successo di una piattaforma di \gls{cf}, non rappresentano più meri obiettivi da perseguire, bensì proprietà strutturali garantite dalla \textit{blockchain} stessa (Tabella~\ref{tab:blockchain_vantaggi}).
...
%La maggior parte degli studi esistenti mostrano un ricorso diffuso a \textit{Smart Contract} per la gestione delle donazioni e a meccanismi di approvazione basati sul consenso dei donatori, per l'approvazione delle richieste di spesa. \\
