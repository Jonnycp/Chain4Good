...
Nello modello proposto da Patil et al., queste clausole automatizzate mirano a impedire il trasferimento immediato e totale dei fondi raccolti verso i beneficiari. In particolare, il capitale viene invece vincolato nel contratto e rilasciato gradualmente solo al completamento di traguardi intermedi stabiliti dai proponenti stessi. Questo approccio, volto garantire che i contributori mantengano il controllo sui fondi investiti, è stato riproposto da Yadav e Sarasvathi, i quali però prevedono che per utilizzare una quota del capitale, il \textit{Project Manager} sottoponga alla piattaforma una specifica richiesta di spesa, indicando l'importo e l'indirizzo del fornitore destinatario del pagamento. La transazione viene autorizzata ed eseguita automaticamente dal contratto solo se la richiesta ottiene il consenso della maggioranza dei sostenitori (superiore al 50\%) attraverso un sistema di voto integrato.
