...
Sebbene questo paradigma abbia democratizzato l'accesso al capitale, l'architettura adottata introduce inefficienze strutturali che limitano il potenziale del modello di \textit{crowdfunding}.
...
% Dall’analisi delle soluzioni esistenti emerge come la tecnologia \textit{blockchain} rappresenti un valido strumento per affrontare alcune delle principali criticità delle piattaforme di \gls{cf} esistenti, in particolare in termini di trasparenza, sicurezza e controllo sull’erogazione dei fondi. 
