...
La letteratura converge nel considerare la \textit{blockchain} come una soluzione promettente per il superamento delle criticità strutturali delle piattaforme di \gls{cf} esistenti \cite{shelke2022blockchain}. In particolare, l'efficacia di tale tecnologia risiede nelle proprietà native di decentralizzazione, trasparenza, immutabilità e sicurezza (Tabella~\ref{tab:blockchain_vantaggi}) che essa implementa. 
...
Nello specifico, nel contesto del \gls{cf}:
\begin{itemize}
	...
	\item la proprietà di immutabilità assicura l’integrità delle informazioni memorizzate \textit{on-chain}, come le transazioni di donazione, i dettagli sulle campagne di raccolta fondi);
...
% favorendo la transizione da un modello basato sulla fiducia in un intermediario a un ecosistema \textit{trustless}, nel quale la validità e integrità delle operazioni è garantita direttamente dall’infrastruttura tecnologica.
