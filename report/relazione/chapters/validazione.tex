...
Tuttavia, data la natura prototipale della piattaforma, l'attività di verifica è stata effettuata progressivamente durante lo sviluppo, piuttosto che sul funzionamento dell'intera piattaforma. Infatti, ogni funzionalità è stata testata immediatamente dopo la sua implementazione attraverso test manuali e mediante l’utilizzo di strumenti di sviluppo dedicati, come \textit{Postman} e richieste HTTP da riga di comando, per validare il corretto comportamento delle API \textit{backend}. Inoltre, sono stati eseguiti test automatizzati sui contratti intelligenti prima della fase di \textit{deploy}, così da individuare eventuali errori logici o comportamenti inattesi in un ambiente controllato.
