...
export default function NuovoProgetto() {
  ...
  const validateStep2 = () => {
    ...
    if (!formData.coverImage) newErrors.coverImage = "È necessario caricare un'immagine.";
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans pb-10 relative flex flex-col">
      ...
      {/* HEADER */}
      <Header type="utente" profileImage={imgUser} activePage="home" showNav={false}/>
      ...
      {/* CONTENUTO NORMALE */}
      <div className={`flex-1 ${isSuccess ? 'blur-sm pointer-events-none' : ''} transition-all`}>
          ...
          <div className="md:bg-white md:p-8 md:rounded-3xl md:shadow-sm">
            ...
            {step === 1 && (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* Budget */}
                    <div>
                        <label className="block text-sm font-bold text-secondary mb-1">Budget target (ETH)</label>
                        <input
                        type="number"
                        onKeyDown={(e) => {
            ...
            {step === 2 && (
                ...
                {/* Descrizione */}
                <div>
                    <label className="block text-sm font-bold text-secondary mb-1">Descrizione completa</label>
                    <textarea
                    name="description"
                    rows={6}
                ...
                {/* Fondi */}
                <div>
                    <label className="block text-sm font-bold text-secondary mb-1">Piano utilizzo fondi</label>
                    <textarea
                    name="fundsUsage"
                    rows={3}
                    ...
                    placeholder="Es: 50% acquisto materiali, 30% logistica..."
                    />
                ...
                <div>
                    ...
                    {formData.coverImage ? (
                        <div className="flex flex-col items-center">
                            <Icon icon="mdi:image-check" className="w-8 h-8 text-primary mb-2" />
                        ...
                        <div className="flex flex-col items-center text-gray-400 group-hover:text-primary transition-colors">
                            ...
                            <span className="text-sm font-medium">Carica una foto</span>
                        </div>
                    )}
                    </div>
